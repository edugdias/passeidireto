...
var host_db = 'mysql.server';
if (process.env.HOST_DB_ADDRESS) {
    host_db = process.env.HOST_DB_ADDRESS;
}

console.log('NodeJs Server is connected to %s MySQL database', host_db);
